...
const About: React.FC = () => {
  return (
    <div className="text-white  w-screen  font-Poppins mx-auto px-6 py-16">
      ...
      {/* Hero Section */}
      <section className="text-center container py-10 mb-16  bg-opacity-50 rounded-lg shadow-lg mx-auto px-6 py-16 shadow">
  ...
  <div className="mb-12 flex flex-col lg:flex-row p-2 items-center container our_logo lg:items-start  mx-auto px-6 py-16">
    ...
    <div className="lg:basis-1/2 flex  justify-center items-center h-[50vh] ">
